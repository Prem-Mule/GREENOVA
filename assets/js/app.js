        ...
        searchTimeout = setTimeout(() => {
            fetchData(url.geo(searchField.value), function (locations) {
                ...
                for (const { name, lat, lon, country, state } of locations) {
                    ...
                    <a href="#/weather?lat=${lat}&lon=&l${lon}" class="item-link has-state" aria-label="${name}weather" data-search-toggler></a>
                `;
            ...
            <h2 class="title-2" id="highlights-label">Today Highlights</h2>
                        <div class="highlight-list">
                            ...
                            <div class="card card-sm highlight-card one">
                                ...
                                <span class="badge aqi-${aqi} label-${aqi}" title="${module.aqiText[aqi].level}">
